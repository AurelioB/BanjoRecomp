...
def main() -> int:
    ...
    require("target_compile_definitions(main PRIVATE BANJO_ANDROID_DEV_FULL_APK=1)" in root_cmake, "dev-ROM APK target must expose BANJO_ANDROID_DEV_FULL_APK to C++")
